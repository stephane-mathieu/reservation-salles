...
<div class="arrow arrow--top responsive">
  ...
  <div class="main ">
    ...
    <h1 class="main__title text-white">Reservation de salles pour notre espace de travail</h1>
    <!-- <h2 class="main__title text-white">Combined with SVGs</h2> -->
